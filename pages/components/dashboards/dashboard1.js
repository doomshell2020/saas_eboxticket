...
import { Breadcrumb, Col, Row, Card, ButtonGroup, Button, ProgressBar, Dropdown, Form } from "react-bootstrap";
                ...
                <Card className="card custom-card">
                  <div className="card-body p-3">
                    <div className="d-flex">
                      <div className="me-2">
                        <span className="rounded p-2 d-flex text-center align-self-center bg-info-transparent">
                          <i className="fe fe-shopping-bag tx-16 text-info"></i>
                        </span>
                      </div>
                  ...
                  <div className="col-4">
                    ...
                    <div className="col-8">
                      <div className="ps-4 pt-4 pe-3 pb-4">
                        <div className="">
                          <h6 className="mb-2 tx-12 ">TOTAL INVITATIONS</h6>
                        </div>
              ...
              <Col>
                <Card className="card custom-card">
                  <div className="card-body p-3">
                    <div className="d-flex">
                      <div className="me-2">
                        <span className="rounded p-2 d-flex text-center align-self-center bg-danger-transparent">
                          <i className="fe fe-shopping-bag tx-16 text-danger"></i>
                        </span>
                      </div>
                    ...
                    <div className="d-flex">
                      <div className="me-2">
                        <span className="rounded p-2 d-flex text-center align-self-center bg-warning-transparent">
                          <i className="fe fe-shopping-bag tx-16 text-warning"></i>
                        </span>
                      </div>
              ...
              <Col>
                <Card className="card custom-card">
                  <div className="card-body p-3">
                    <div className="d-flex">
                      <div className="me-2">
                        <span className="rounded p-2 d-flex text-center align-self-center bg-primary-transparent">
                          <i className="fe fe-shopping-bag tx-16 text-primary"></i>
                        </span>
                      </div>
          ...
          <Col xxl={7} xl={12} lg={12} md={12} sm={12}>
            <Card className=" custom-card overflow-hidden">
              <Card.Header className="">
                <div>
                  <h3 className="card-title mb-2 ">Revenue Analytics</h3>
            ...
            <Row>
              <Col sm={12} lg={12} xl={6}>
                <Card className="card overflow-hidden">
                  <Card.Header className=" pb-1">
                    <h3 className="card-title mb-2">Last 10 Invitations Received</h3>
                  </Card.Header>
              ...
              <Col lg={12} xl={6}>
                <Card>
                  <Card.Header className="pb-1">
                    <h3 className="card-title mb-2">Month Wise Invitations</h3>
                  </Card.Header>
                  {/* <Card.Body className="p-0 customers mt-1">
                    <div className="">
          ...
          <Col sm={12} lg={12} xl={6} xxl={3}>
            <Card>
              <Card.Header className=" pb-3">
                <h3 className="card-title mb-2">Past Events</h3>
              </Card.Header>
              <Card.Body className="p-0 customers mt-1">
