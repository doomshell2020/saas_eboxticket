...
const Attachments = () => (
  <div>
    <Seo title={"File attachment taga"}/>
              ...
              <div className="text-wrap pb-3">
                ...
                <div className="file-image-1">
                  <div className="product-image">
                    <Link href={`/components/apps/file-details/`}>
                      <img
                        src={"../../../assets/img/files/file2.png" }
                        alt=""
                      />
                    </Link>
                    <ul className="icons">
                ...
                <div className="file-image-1">
                  <div className="product-image">
                    <Link href={`/components/apps/file-details/`}>
                      <img
                        src={"../../../assets/img/media/climate.jpg" }
                        className="br-5"
                        alt=""
                      />
                    </Link>
...
Attachments.layout = "Contentlayout"
