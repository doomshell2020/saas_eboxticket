        ...
        <Card>
          <Card.Header className=" pb-0">
            ...
            <p className="tx-12 tx-gray-500 mb-2">
              Example of Nowa Simple Table. <Link href="#!">Learn more</Link>
            </p>
          </Card.Header>
          <Card.Body>
      ...
      <Col xl={12}>
        <Card>
          <Card.Header className=" pb-0">
            ...
            <p className="tx-12 tx-gray-500 mb-2">
              Example of Nowa Striped Rows.. <Link href="#!">Learn more</Link>
            </p>
          </Card.Header>
          <Card.Body>
          <div className="table-responsive">
      ...
      <Col xl={12}>
        <div className="card mg-b-20">
          <Card.Header className=" pb-0">
            ...
            <p className="tx-12 tx-gray-500 mb-2">
              Example of Nowa Bordered Table.. <Link href="#!">Learn more</Link>
            </p>
          </Card.Header>
          <Card.Body>
          <div className="table-responsive">
      ...
      <Col xl={12}>
        <Card>
          <Card.Header className=" pb-0">
            ...
            <p className="tx-12 tx-gray-500 mb-2">
              Example of Nowa Hoverable Rows Table.. <Link href="#!">Learn more</Link>
            </p>
          </Card.Header>
          <Card.Body>
          <div className="table-responsive">
...
DefaultTables.layout = "Contentlayout"
