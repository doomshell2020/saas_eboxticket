        ...
        <Col className="mg-md-t-0" sm={12} md={12} lg={4} xl={4}>
          <Card className=" bg-primary tx-white bd-0">
            <Card.Body>
              ...
              <Link className="card-link tx-white-7 hover-white" href="#!">
                Card link
              </Link>{" "}
              <Link className="card-link tx-white-7 hover-white" href="#!">
                Another link
        ...
        <Col sm={12} md={12} lg={4} xl={4}>
          <Card>
            <Card.Body>
              ...
              <Link href="#!" className="card-link text-secondary">
                Card link
              </Link>
              <Link href="#!" className="card-link text-secondary">
                Another link
        ...
        <Col sm={12} md={12} lg={4} xl={4}>
          <Card className=" bg-info">
            <Card.Body>
              ...
              <Link href="#!" className="card-link text-white">
                Card link
              </Link>
              <Link href="#!" className="card-link text-white">
                Another link
          ...
          <Card>
            ...
            <div className="card-img-overlay pd-30 bg-black-4 d-flex flex-column justify-content-center br-5 ">
              ...
              <p className="tx-13 mg-b-0">
                <Link className="tx-white" href={`/components/advancedui/blog/`}>
                  Read more
                </Link>
              </p>
            </div>
        ...
        <Col className="mg-md-t-0" sm={12} md={12} lg={4} xl={4}>
          <Card>
            ...
            <Card.Footer className=" bd-t tx-center">
              <Link href={`/components/advancedui/blog/`}>Read more</Link>
            </Card.Footer>
          </Card>
        </Col>
        <Col className="mg-md-t-0" sm={12} md={12} lg={4} xl={4}>
        ...
        <Col sm={12} md={12} lg={4} xl={4}>
          <Card>
            <Card.Body>
              ...
              <Link href={`/components/advancedui/blog/`} className="btn btn-primary">
                See more
              </Link>
            </Card.Body>
          </Card>
        ...
        <Col sm={12} md={12} lg={4} xl={4}>
          <Card className=" text-center card-img-top-1">
            ...
            <Card.Body>
              ...
              <Link className="btn btn-primary btn-block" href={`/components/advancedui/blog/`}>
                Read More
              </Link>
            </Card.Body>
          </Card>
