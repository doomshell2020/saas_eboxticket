        ...
        <Card className="bd-0 mg-b-20">
          <Card.Body className="text-danger bg-danger-transparent br-5 bd bd-danger">
            <div className="main-error-wrapper">
              ...
              <Link className="btn btn-outline-danger btn-sm" href="#!">
        ...
        <Card className="bd-0 mg-b-20">
          <Card.Body className="text-success bg-success-transparent br-5  bd bd-success">
            <div className="main-error-wrapper">
              ...
              <Link className="btn btn-outline-success btn-sm" href="#!">
                Click to view details
              </Link>
            </div>
          </Card.Body>
        ...
        <Card className="bd-0 mg-b-20">
          <Card.Body className="text-warning bg-warning-transparent br-5  bd bd-warning">
            <div className="main-error-wrapper">
              ...
              <Link className="btn btn-outline-warning btn-sm" href="#!">
                Click to view details
              </Link>
            </div>
          </Card.Body>
        ...
        <Card className="bd-0 mg-b-20">
          <Card.Body className="text-info bg-info-transparent br-5 bd bd-info">
            <div className="main-error-wrapper">
              ...
              <Link className="btn btn-outline-info btn-sm" href="#!">
                Click to view details
              </Link>
            </div>
          </Card.Body>
    ...
    <Row className="row-sm">
      <Col xl={4} md={6} lg={6}>
        <Card className="mg-b-20 text-center">
          <Card.Body className="h-100">
            <img
              src={"../../../assets/img/svgicons/no-data.svg"}
              alt=""
              className="wd-35p"
            />
      ...
      <Col xl={4} md={6} lg={6}>
        <Card className="mg-b-20 text-center">
          <Card.Body className="h-100">
            <img
              src={"../../../assets/img/svgicons/note_taking.svg"}
              alt=""
              className="wd-35p"
            />
      ...
      <Col xl={4} md={6} lg={6}>
        <Card className="mg-b-20 text-center">
          <Card.Body className="h-100">
            <img
              src={"../../../assets/img/svgicons/imac.svg"}
              alt=""
              className="wd-40p"
            />
