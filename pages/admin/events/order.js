...
const EventOrders = () => {
    ...
    const [COLUMNS, setCOLUMNS] = useState([
        ...
        },
        {
            ...
            Cell: ({ row }) => (
                <div>
                    <b><Link href={`/admin/events/invitationdetail/?orderId=${row.original.orderid}`}>
                        # {row.original.orderrrn}</Link></b><br />
                    <strong>Stripe Key:-</strong> {row.original.stripekey}
                </div>
            )
        },
        ...
        },
        {
            ...
            Cell: ({ row }) => (
                <div>
                    {row.original.currencysign} {row.original.totalamount} {row.original.currencyvalue}
                </div>
            ),
        },
        {
    ...
    const handleVieworders = async () => {
        const API_URL = 'https://staging.eboxtickets.com/embedapi/myticketsadmin';
        axios.post(API_URL, {
            headers: {
        ...
        <>
            ...
            <div className="breadcrumb-header justify-content-between">
                <div className="left-content">
                    <span className="main-content-title mg-b-0 mg-b-lg-1">Events Orders</span>
                </div>
...
EventOrders.layout = "Contentlayout"
