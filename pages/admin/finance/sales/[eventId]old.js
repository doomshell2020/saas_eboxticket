                                                    ...
                                                    <div className="admin-financeMain">
                                                        <Table striped bordered hover className="responsive-table">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <th><strong>Cancel Addons</strong></th> {/* Moved to First Column */}
                                                                ...
                                                                <tr>
                                                                    <th><strong>Cancel Amount ({eventData?.currencySymbol})</strong></th> {/* Moved to First Column */}
                                                                ...
                                                                <tr>
                                                                    <th><strong>Total Received Amount ({eventData?.currencySymbol})</strong></th> {/* Moved to First Column */}
