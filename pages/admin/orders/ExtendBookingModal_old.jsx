                        ...
                        <div className="row mb-3">
                            <div className="col-md-6">
                                <CFormLabel htmlFor="NewCheckInDate">
                                    New Check-in Date <span style={{ color: "red" }}>*</span>
                                </CFormLabel>
                                    ...
                                    <DatePicker
                                        ...
                                        onChange={(date) => {
                                            ...
                                            if (selectedDate >= bookedStart && selectedDate < bookedEnd) {
                                                setExtendError("Selected date overlaps with existing booking.");
                                                setCheckInDate("");
                                            } else {
                                                setExtendError("");
                                        ...
                                        includeDateIntervals={[
                                            ...(parseLocalDate(eventHousing.AvailabilityStartDate) <
                                                parseLocalDate(extendBookingRow.check_in_date)
                                                ? [{
                            ...
                            <div className="col-md-6">
                                <CFormLabel htmlFor="NewCheckOutDate">
                                    New Check-out Date <span style={{ color: "red" }}>*</span>
                                </CFormLabel>
                                <InputGroup className="position-relative">
                                    <InputGroup.Text className="input-group-text">
                                        <i className="typcn typcn-calendar-outline tx-24 lh--9 op-6"></i>
                                    ...
                                    <DatePicker
                                        ...
                                        minDate={checkInDate ? parseLocalDate(checkInDate) : undefined}
                                        dateFormat="yyyy-MM-dd"
                                        className="form-control"
